...
const catColors: Record<string,string> = {"Cost & Insurance":"#16A34A","Restoration Process":"#2563EB","Prevention & Education":"#D97706","Mold & Health":"#DC2626","Flood Preparedness":"#7C3AED"};
const catEmoji: Record<string,string> = {"Cost & Insurance":"💰","Restoration Process":"🔧","Prevention & Education":"🔍","Mold & Health":"🦠","Flood Preparedness":"🌊"};
    ...
    <div style={{background:"#F9FAFB"}}>
      <main className="bl">
        ...
        <div className="bl-grid" role="list" aria-label="Blog articles">
          {[...getPublishedBlogPosts(), ...blogPosts].map(post=>(
