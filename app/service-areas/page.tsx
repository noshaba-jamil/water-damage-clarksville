...
export const metadata: Metadata = { title:"Service Areas | Water Damage Restoration Clarksville TN", description:"Water damage restoration serving Clarksville TN, Fort Campbell, Oak Grove, Hopkinsville, and Sango. 60-min response. Call (931) 271-2350.", alternates:{canonical:"/service-areas"} };
...
// This page's FAQ section previously had no FAQPage schema behind it at
// all, unlike every other page on the site. Generated directly from the
// same list rendered below so the two can't drift apart.
const areaFaqs = [
    ...
    <div style={{background:"#F9FAFB"}}>
      <main className="sa">
        ...
        <section className="sa-faq" aria-labelledby="faq-h">
          ...
          {areaFaqs.map((faq,i)=><details key={i} className="faq-item"><summary className="faq-q">{faq.q}</summary><p className="faq-a">{faq.a}</p></details>)}
        </section>
