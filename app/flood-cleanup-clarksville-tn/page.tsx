...
export const metadata: Metadata = {
  ...
  description:
    "Professional flood cleanup in Clarksville TN. Industrial truck-mounted extraction, same-day service, structural drying. All insurance including USAA. Call (931) 271-2350.",
...
// NEW — FAQ schema, tied to the new FAQ section below.
const faqSchema = {
  "@context": "https://schema.org",
  "@type": "FAQPage",
  mainEntity: [
    ...
    {
      "@type": "Question",
      name: "How fast do you respond to flooding emergencies in Clarksville?",
      acceptedAnswer: {
        "@type": "Answer",
        text: "We guarantee 60-minute on-site arrival anywhere in Clarksville TN and Montgomery County, 24/7/365. A real technician answers your call in under 60 seconds — no automated menus.",
      },
    },
  ],
};
...
// NEW — full service list, linking every other service page
      ...
      <div style={{ background: "#fff" }}>
        <div className="sp">
          <main>
            ...
            <p className="sp-p">
              We serve all of Clarksville TN, Fort Campbell, Montgomery
              County, and surrounding areas — including Oak Grove KY and
              Hopkinsville KY. All insurance claims handled directly. USAA
              specialists for Fort Campbell military families.
            </p>

            <span id="causes" className="sp-ey" style={{ marginTop: 32 }}>Common Flood Causes We Handle</span>
            ...
            <span id="process" className="sp-ey" style={{ marginTop: 32 }}>Our 8-Step Flood Cleanup Process</span>
            <div className="steps">
              {steps.map((s) => (
            ...
            <span id="included" className="sp-ey" style={{ marginTop: 32 }}>What&apos;s Included</span>
            <ul className="list">
              {["Industrial truck-mounted water extraction (800+ GPH)", "Thermal imaging to find hidden moisture in walls & floors", "Industrial LGR dehumidifiers and air movers", "IICRC S500-certified structural drying protocols", "Antimicrobial treatment to prevent mold", "Complete moisture log documentation for insurance", "Direct insurance billing — you pay only your deductible", "Certificate of dryness at project completion", "USAA-preferred contractor for Fort Campbell families", "24/7 monitoring of drying equipment"].map((i) => (
                <li key={i}>{i}</li>
              ))}
            </ul>

            <div style={{ background: "#09090B", borderRadius: 12, padding: 32, margin: "40px 0", textAlign: "center" }}>
              <div style={{ fontFamily: "var(--font-cormorant)", fontSize: "clamp(22px,3vw,34px)", fontWeight: 700, color: "#fff", marginBottom: 10, letterSpacing: -0.5 }}>
                Flooding Right Now?
              </div>
              <p style={{ fontFamily: "var(--font-inter)", fontSize: 14, color: "rgba(255,255,255,.5)", marginBottom: 22, maxWidth: 440, margin: "0 auto 22px", lineHeight: 1.7 }}>
                Don&apos;t wait. Water damage doubles every hour. Our team is ready 24/7 and arrives in 60 minutes or less.
              </p>
            ...
            <span id="faq" className="sp-ey">Flood Cleanup FAQ</span>
            <div>
              {faqs.map((faq, i) => (
            ...
            <span id="all-services" className="sp-ey" style={{ marginTop: 32 }}>All Water Damage Services in Clarksville TN</span>
          ...
          <aside className="sp-sb">
            ...
            <div className="trust-box">
              <h3>Why Choose Us</h3>
              {["✅ IICRC S500 Certified", "✅ 60-min guaranteed arrival", "✅ All insurance accepted", "✅ USAA specialists", "✅ Serving Clarksville since 2014", "✅ Direct insurance billing", "✅ Free assessment"].map((t) => (
                <div key={t} className="trust-item">{t}</div>
              ))}
            </div>
            <div style={{ background: "#F9FAFB", border: "1px solid #E4E4E7", borderRadius: 10, padding: 20 }}>
              <h3 style={{ fontFamily: "var(--font-inter)", fontSize: 12, fontWeight: 700, textTransform: "uppercase", letterSpacing: 1, color: "#09090B", marginBottom: 12 }}>
                Service Areas
              </h3>
              {["Clarksville TN", "Fort Campbell", "Sango TN", "Oak Grove KY", "Hopkinsville KY", "Springfield TN", "Ashland City TN"].map((a) => (
                <div key={a} style={{ fontFamily: "var(--font-inter)", fontSize: 13, color: "#52525B", marginBottom: 6, display: "flex", alignItems: "center", gap: 6 }}>
